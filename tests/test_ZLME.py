...
from functions_scrapping import ZLME_scrap

class TestZLMEScrap(unittest.TestCase):

    @patch('requests.get')
    def test_ZLME_scrap(self, mock_get):
        ...
        result = ZLME_scrap(start_date, end_date)
        ...
        result_without_dates = ZLME_scrap()
